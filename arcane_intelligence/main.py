...
async def main():
  ...
  system_message = ChatMessage.system("你是 Kimi，由 Moonshot AI 提供的人工智能助手，你更擅长中文和英文的对话。你会为用户提供安全，有帮助，准确的回答。")
  user_message = ChatMessage.user("你好，我是羊肉，2 + 2等于多少")

  chat_history.append(system_message)
  chat_history.append(user_message)

  response = await ai_provider.create_chat_completion([system_message, user_message], "moonshot-v1-8k")
